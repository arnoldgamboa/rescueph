...
}elseif (empty($rescues)) { echo '<div id="map_canvas" style="height:400px;"></div>'; }
...
<div id="more"></div>
<div style="margin-left:auto: margin-right:auto;"><a href="javascript:;" class="btn danger more">More...</a></div>
...
<script>
	$(function(){
		...
		$(".more").click(function(){
			count = count + 30;
			$.get(" <?php echo Uri::create('ajax/more/') ?>" + count, function(data){
				$("#more").html(data);
			})
		});
	})
